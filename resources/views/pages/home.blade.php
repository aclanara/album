...
<header class="text-white gradient">
  ...
  <div class="jumbotron bg-transparent text-center py-5">
    <div class="container">
      ...
      <br>
      <p class="lead text-white-50">Something short and leading about the collection below—its contents, the creator, etc. Make it short and sweet, but not too short so folks don’t simply skip over it entirely.</p>
      <br>
    <form action="">
